      ...
      {showSidebar && <div className='fixed w-full h-full z-10 bg-black/80 md:hidden'></div>}
          ...
          <main className=' p-8 space-y-6 max-sm:p-0 max-sm:mt-2 max-sm:space-y-4'>
            ...
            <div className="flex justify-center items-center p-5">
              <button className="px-2 py-1 mx-1 bg-white border border-gray-200 rounded-md text-gray-500" >
                <i className="bi bi-chevron-left"></i> Previous
              </button>
              <button
                key={1}
                className={`px-3 py-1 mx-1 bg-[#146EB4] text-white rounded-md`}
              >
                {1}
              </button>
              <button
                key={2}
                className={`px-3 py-1 mx-1 bg-white text-gray-500`}
              >
                {2}
              </button>
              <button
